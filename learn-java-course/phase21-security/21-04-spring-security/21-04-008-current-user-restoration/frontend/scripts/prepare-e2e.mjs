...
const temporaryLesson = resolve(temporaryModule, '21-04-008-current-user-restoration');
...
// 对照版保留用户、CSRF、会话与本课/me，只恢复默认登录响应用于回归。
rmSync(resolve(temporaryLesson, 'src/main/java/cn/ningbingjian/learnjava/security/lesson008/FormLoginHandlers.java'));
const config = resolve(temporaryLesson, 'src/main/java/cn/ningbingjian/learnjava/security/lesson008/SecurityConfig.java');
