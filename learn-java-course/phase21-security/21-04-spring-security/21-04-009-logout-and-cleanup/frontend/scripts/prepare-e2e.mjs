...
const temporaryLesson = resolve(temporaryModule, '21-04-009-logout-and-cleanup');
...
rmSync(resolve(temporaryLesson, 'src/main/java/cn/ningbingjian/learnjava/security/lesson009/FormLoginHandlers.java'));
const config = resolve(temporaryLesson, 'src/main/java/cn/ningbingjian/learnjava/security/lesson009/SecurityConfig.java');
