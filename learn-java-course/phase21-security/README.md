...
已建立 [21-04模块入口](21-04-spring-security/README.md)、[逐课大纲](21-04-spring-security/00-模块学习大纲.md)、[版本基线](21-04-spring-security/01-版本基线.md)，并提供独立前端、浏览器联合验证，以及[第001课](21-04-spring-security/21-04-001-hello-spring-security/README.md)、[第002课](21-04-spring-security/21-04-002-explicit-security-filter-chain/README.md)、[第003课正文与源码](21-04-spring-security/21-04-003-api-authentication-errors/README.md)、[第004课正文与源码](21-04-spring-security/21-04-004-request-matching-boundaries/README.md)和[第005课正文与源码](21-04-spring-security/21-04-005-users-and-password-encoding/README.md)。Spring Security大纲已细化为八篇89课（80课主线、9课选修），第001—005课已实现，第一篇已齐备，第二篇已开始，第006课及后续课程仍待编写。其余模块目前仍为总纲规划，不代表已经提供课程正文。
